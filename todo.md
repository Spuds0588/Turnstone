...
- [x] UI copy: `accept=` on the file input, `FS_PICK_OPTS` types, welcome panel, empty states, and the PWA description all widened; the welcome button is now **Choose file…**.
